    ...
    void calculate(ActionEvent event) {
        ...
        switch (calculationType) {
            ...
            case "-":
                ...
                break;
            case "/":
                double calculatedNumberDouble = firstNumberInt / (double)secondNumberInt;
                savedNumbers.setText(firstNumber + " / " + currentNumber + " = " + calculatedNumberDouble);
                textField.setText(String.valueOf(calculatedNumberDouble));
                break;
            case "*":
                calculatedNumber = firstNumberInt * secondNumberInt;
                savedNumbers.setText(firstNumber + " * " + currentNumber + " = " + calculatedNumber);
